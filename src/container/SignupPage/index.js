...
const Signup = () => {
  ...
  const handleChange = (e) => {
    ...
    const errors = {
      ...
      confirmPassword: name === "confirmPassword" && validateConfirmPassword(formData.password, value),
  ...
  const handleSubmit = async(e) => {
    e.preventDefault();
    const { first_name, last_name, email, password, confirmPassword, companyname } = formData;
    const errors = {
